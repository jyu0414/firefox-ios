...
// think is fine but if needed we can disable user scrolling in this case - :sleroux
private class TabTrayCollectionViewLayout: UICollectionViewFlowLayout {
    private override func collectionViewContentSize() -> CGSize {
        ...
        if calculatedSize.height < collectionView!.bounds.size.height {
            calculatedSize.height = collectionView!.bounds.size.height + 1
        }
